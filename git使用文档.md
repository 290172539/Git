...
| 版本  |       作者        |    时间    |   备注   |
| :---: | :---------------: | :--------: | :------: |
| V 1.0 | bug设计设计工程师 | 2021/09/05 | 创建文件 |
...
- `$ git reset --hard 7bf0e31`：基于索引值操作[推荐] （7bf0e31再**图4.1**中查看）
...
4. 邀请成员，登录自己的github账在，浏览器号访问邀请码即可。
...
5. 接收方审核代码，确认没问题可以允许合并
    ...
    ![1630930612223](git使用文档/1630930612223.png)
